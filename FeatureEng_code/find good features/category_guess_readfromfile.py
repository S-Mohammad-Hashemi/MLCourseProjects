...
def accuracy(classifier, x, y,labels, examples):
    ...
    shortLB=[label[:2] for label in labels]
    print("\t".join(shortLB))
    for ii in cm:
...
if __name__ == "__main__":
    ...
    list_total_test=[(ex,y) for ex,y in all_examples(texts,total_y,train=False) ]
...
#     good_features= ["pulsar discoveri diagram jupit star discov methan supernova cloud astronom",
#     "lesion peptid defect membran disrupt genet assay affect cytoplasm select",
#     "marangoni qubit extent gravit virial mirror planck voltag energet physic",
#     "earli sine ionic by contrast row machin intersect photoelectr this",
#     "spoken thinker spear sick sermon easter reed constitut distinguish of",
#     "huon moresbi astrolab mangrov digul kavieng boluminski namatanai lae eastern",
#     "solomon upward analysi congo demon weber birthplac babylonian descart classif",
#     "altern prepar gase stabil jon chemistri ph add presenc chemist",
#     "iron glacier low character ocean deep fossil metamorph hot mantl",
#     "le architectur background paint piano painter fresco compos opera pointsnam",
#     "plateau built revers dam popul contin strait illinoi tribe geograph",
#     "upheld relief anoth clarenc successor veteran resign byzantin that thi",
#     "anoth when literatur literari an the that he at thi",
#     "bernoulli mathemat scheme recurs abelian vertex satisfi notat subset topolog"]
...
#         tokens=x.split(",")
#         print "correct label is:", tokens[-1]
#         feature_vector=""
#         for i in range(len(tokens)-1):
# #             if(i%2 == 0):
#             feature_vector+=tokens[i].split(" ")[0]+" "
#         print feature_vector
# #         if(index % 5 != 0):
#         list1.append(feature_vector)
#         list3.append(tokens[-1])
